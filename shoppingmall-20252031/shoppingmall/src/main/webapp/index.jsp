...
<%
    ...
    // BEST 상품: PRODUCT 테이블에서 조회 (Cache Aside 패턴 적용)
    List<ProductDto> bestProducts = new ProductService().getProducts();
    ...
    <section>
        ...
        <div class="product-grid">
            <% for (int i = 0; i < bestProducts.size(); i++) {
                ProductDto p = bestProducts.get(i);
                String productId = p.getId();
                String productName = p.getName();
                String productBrand = p.getBrand();
                int productPrice = p.getSalePrice();
                String productImage = IMG + p.getImage() + "/400/400";
            ...
            %>
                <div class="product-card"
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-name"><a href="/product/detail.jsp?id=<%= productId %>" style="color:inherit; text-decoration:none;"><%= productName %></a></div>
                        <div class="product-price">
                            <span class="discount"><%= p.getDiscountRate() %>%</span>
                            <span class="price"><%= String.format("%,d", p.getSalePrice()) %>원</span>
                            <span class="original"><%= String.format("%,d", p.getPrice()) %>원</span>
                        </div>
